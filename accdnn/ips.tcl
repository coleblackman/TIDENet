...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {512} CONFIG.Write_Depth_A {100} CONFIG.Write_Width_B {1024} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips conv1_wm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Single_Port_ROM} CONFIG.Write_Width_A {256} CONFIG.Write_Depth_A {2} CONFIG.Enable_A {Always_Enabled} CONFIG.Load_Init_File {true} CONFIG.Coe_File {../../../../../coe//conv1_bm_ram.coe} CONFIG.Fill_Remaining_Memory_Locations {true}] [get_ips conv1_bm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {256} CONFIG.Write_Depth_A {160} CONFIG.Write_Width_B {256} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips pool1_rm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {256} CONFIG.Write_Depth_A {96} CONFIG.Write_Width_B {128} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips conv2_rm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {512} CONFIG.Write_Depth_A {400} CONFIG.Write_Width_B {2048} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips conv2_wm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Single_Port_ROM} CONFIG.Write_Width_A {128} CONFIG.Write_Depth_A {2} CONFIG.Enable_A {Always_Enabled} CONFIG.Load_Init_File {true} CONFIG.Coe_File {../../../../../coe//conv2_bm_ram.coe} CONFIG.Fill_Remaining_Memory_Locations {true}] [get_ips conv2_bm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {128} CONFIG.Write_Depth_A {160} CONFIG.Write_Width_B {256} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips pool2_rm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {256} CONFIG.Write_Depth_A {48} CONFIG.Write_Width_B {128} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips conv3_rm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {512} CONFIG.Write_Depth_A {200} CONFIG.Write_Width_B {1024} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips conv3_wm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Single_Port_ROM} CONFIG.Write_Width_A {64} CONFIG.Write_Depth_A {8} CONFIG.Enable_A {Always_Enabled} CONFIG.Load_Init_File {true} CONFIG.Coe_File {../../../../../coe//conv3_bm_ram.coe} CONFIG.Fill_Remaining_Memory_Locations {true}] [get_ips conv3_bm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {64} CONFIG.Write_Depth_A {320} CONFIG.Write_Width_B {256} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips pool3_rm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {256} CONFIG.Write_Depth_A {64} CONFIG.Write_Width_B {16} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips ip1_rm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {512} CONFIG.Write_Depth_A {64} CONFIG.Write_Width_B {32} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips ip1_wm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Single_Port_ROM} CONFIG.Write_Width_A {16} CONFIG.Write_Depth_A {32} CONFIG.Enable_A {Always_Enabled} CONFIG.Load_Init_File {true} CONFIG.Coe_File {../../../../../coe//ip1_bm_ram.coe} CONFIG.Fill_Remaining_Memory_Locations {true}] [get_ips ip1_bm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {16} CONFIG.Write_Depth_A {64} CONFIG.Write_Width_B {8} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips ip2_rm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {512} CONFIG.Write_Depth_A {4} CONFIG.Write_Width_B {16} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips ip2_wm_ram]
