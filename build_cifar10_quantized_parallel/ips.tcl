...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {512} CONFIG.Write_Depth_A {64} CONFIG.Write_Width_B {64} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips ip1_wm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Single_Port_ROM} CONFIG.Write_Width_A {16} CONFIG.Write_Depth_A {16} CONFIG.Enable_A {Always_Enabled} CONFIG.Load_Init_File {true} CONFIG.Coe_File {../../../../../coe//ip1_bm_ram.coe} CONFIG.Fill_Remaining_Memory_Locations {true}] [get_ips ip1_bm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Write_Width_A {512} CONFIG.Write_Depth_A {2} CONFIG.Write_Width_B {32} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled}] [get_ips ip2_wm_ram]
...
set_property -dict [list CONFIG.Memory_Type {Single_Port_ROM} CONFIG.Write_Width_A {8} CONFIG.Write_Depth_A {5} CONFIG.Enable_A {Always_Enabled} CONFIG.Load_Init_File {true} CONFIG.Coe_File {../../../../../coe//ip2_bm_ram.coe} CONFIG.Fill_Remaining_Memory_Locations {true}] [get_ips ip2_bm_ram]
