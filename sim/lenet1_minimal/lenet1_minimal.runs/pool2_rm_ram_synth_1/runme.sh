...
HD_PWD='/home/mm4uz/Desktop/research/tidenet/try6/TIDENet/accdnn/build/ips_prj/ips_prj.runs/pool2_rm_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pool2_rm_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pool2_rm_ram.tcl
