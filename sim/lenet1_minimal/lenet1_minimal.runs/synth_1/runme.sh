...
HD_PWD='/home/mm4uz/Desktop/research/tidenet/try6/lenet1_minimal/lenet1_minimal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log model.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source model.tcl
