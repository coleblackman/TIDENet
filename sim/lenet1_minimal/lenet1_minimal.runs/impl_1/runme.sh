...
HD_PWD='/home/mm4uz/Desktop/research/tidenet/try6/lenet1_minimal/lenet1_minimal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log model.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source model.tcl -notrace
