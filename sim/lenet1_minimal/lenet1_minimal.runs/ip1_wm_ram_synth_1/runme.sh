...
HD_PWD='/home/mm4uz/Desktop/research/tidenet/try6/TIDENet/accdnn/build/ips_prj/ips_prj.runs/ip1_wm_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip1_wm_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip1_wm_ram.tcl
