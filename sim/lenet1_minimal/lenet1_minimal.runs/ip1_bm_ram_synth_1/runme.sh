...
HD_PWD='/home/jmz8rm/tidenet/sim/lenet1_minimal.runs/ip1_bm_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip1_bm_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip1_bm_ram.tcl
