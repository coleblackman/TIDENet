...
HD_PWD='/home/mm4uz/Desktop/research/tidenet/try6/TIDENet/accdnn/build/ips_prj/ips_prj.runs/mul16x16_signed_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul16x16_signed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul16x16_signed.tcl
