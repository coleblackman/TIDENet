...
HD_PWD='/home/jmz8rm/tidenet/sim/lenet1_minimal.runs/conv2_bm_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv2_bm_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv2_bm_ram.tcl
