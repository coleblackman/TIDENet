...
HD_PWD='/home/jmz8rm/tidenet/sim/caravel_mapping/caravel_mapping.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controller_v2_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controller_v2_b.tcl
